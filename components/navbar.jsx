  ...
  return(
    <div className="w-full flex flex-col">
      <div className='w-full h-[100px] bg-[#0495A8] flex justify-between items-center px-2 md:px-[60px]'>
        ...
        <ul className='hidden md:flex md:justify-center md:items-center md:text-white md:gap-[40px]'>
          ...
          <li className='hover:underline hover:underline-offset-2 transition ease-in-out duration-300'>
            <Link href='/' className={router.pathname == '/tienda' ? 'underline underline-offset-2' : ''}>TIENDA</Link>
          </li>
          <li className='hover:underline hover:underline-offset-2 transition ease-in-out duration-300'>
      ...
      <div>
        <ul id='movilmenu' className={'absolute w-full flex flex-col gap-2 py-2 justify-center items-center text-white bg-[#0495A8] h-[0px] transition-height ease-linear duration-500'}>
          <li className='hidden'>
              <Link href='/' className={router.pathname == '/' || router.pathname == '/inicio' ? 'underline underline-offset-2' : ''} >INICIO</Link>
          </li>
          <li className='hidden'>
