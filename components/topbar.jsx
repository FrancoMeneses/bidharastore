...
export default function Topbar () {
  return(
    <div className="w-full h-[60px] bg-[#014D64] flex justify-center items-center px-2 md:px-4 md:justify-between md:gap-6">
      <p className='text-[13px] font-text text-justify font-[100] text-white md:text-left md:text-[15px] lg:text-[18px]'>
        <span className='font-semibold'>
          Entregas al siguiente día solo en la ciudad de Puebla*
        </span> 
