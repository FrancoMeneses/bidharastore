...
export default function Topbar () {
  return(
    <div className="w-full h-[60px] bg-[#014D64] flex justify-center items-center px-2 md:px-4 md:justify-between md:gap-6">
      <p className='text-[13px] text-justify font-[100] text-white md:text-left md:text-[17px] lg:text-[20px]'><span className='font-[300]'>Entregas al siguiente día solo en la ciudad de Puebla*</span> Para información sobre envío a otra ciudad o estado dar click aquí.</p>
